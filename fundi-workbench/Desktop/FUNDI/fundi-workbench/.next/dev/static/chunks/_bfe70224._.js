 ...
 */ function WokwiPartNode({ id: nodeId = 'preview', data, partType: propPartType }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WokwiPartNode.useEffect": ()=>{
            ...
            const attrs1 = data?.attrs ?? {};
            const addr = parseI2CAddress(attrs1.i2cAddress ?? attrs1.address, 0x27);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WokwiPartNode.useEffect": ()=>{
            ...
            const attrs1 = data?.attrs ?? {};
            const addr = parseI2CAddress(attrs1.i2cAddress ?? attrs1.address, 0x3c);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WokwiPartNode.useEffect": ()=>{
            ...
            const handleKeypadPress = {
                "WokwiPartNode.useEffect.handleKeypadPress": (e)=>{
                    ...
                    const partIndex = parts.findIndex({
                        "WokwiPartNode.useEffect.handleKeypadPress.partIndex": (p)=>p.id === nodeId
                    }["WokwiPartNode.useEffect.handleKeypadPress.partIndex"]);
                    if (partIndex !== -1) {
                        const part = parts[partIndex];
                        const currentKeys = part.attrs?.pressedKeys || [];
            ...
            }["WokwiPartNode.useEffect.handleKeypadPress"];
            const handleKeypadRelease = {
                "WokwiPartNode.useEffect.handleKeypadRelease": (e)=>{
                    const detail = e.detail;
                    ...
                    const parts = state.circuitParts || [];
                    const partIndex = parts.findIndex({
                        "WokwiPartNode.useEffect.handleKeypadRelease.partIndex": (p)=>p.id === nodeId
                    }["WokwiPartNode.useEffect.handleKeypadRelease.partIndex"]);
                    if (partIndex !== -1) {
                        const part = parts[partIndex];
                        const currentKeys = part.attrs?.pressedKeys || [];
                        const newKeys = currentKeys.filter({
                            "WokwiPartNode.useEffect.handleKeypadRelease.newKeys": (k)=>k !== detail.key
                        }["WokwiPartNode.useEffect.handleKeypadRelease.newKeys"]);
                        state.updatePartAttrs(nodeId, {
                            ...part.attrs,
                            pressedKeys: newKeys
                        });
            ...
            }["WokwiPartNode.useEffect.handleKeypadRelease"];
...
_s(WokwiPartNode, "/UIhGhHTPaGhp9Om2chaQeVydbo=");
_c = WokwiPartNode;
...
const useAppStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])()((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persist"])((set, get)=>({
        ...
        updatePartAttrs: (id, attrs)=>{
            set({
                circuitParts: get().circuitParts.map((p)=>p.id === id ? {
                        ...p,
                        attrs: {
                            ...p.attrs,
                            ...attrs
...
"[project]/utils/simulation/servo.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class ServoDevice {
    ...
    cpuFrequencyHz;
    onAngleChange;
    pulseStartCycle = null;
    lastPulseWidthUs = 1500;
    lastAngle = 90;
    lastPinState = false;
   ...
   */ tick(cpuCycles) {
        const pinState = this.port.pinState(this.bit);
        const isHigh = pinState === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$avr8js$2f$dist$2f$esm$2f$peripherals$2f$gpio$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PinState"].High;
...
"[project]/utils/simulation/hcsr04.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class HCSR04Device {
    ...
    getDistanceCm;
    scheduler = new __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$simulation$2f$cycleScheduler$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CycleScheduler"]();
    trigHighStartCycle = null;
    echoActive = false;
    // Timing constants
    MIN_TRIG_PULSE_US = 10;
    ECHO_DELAY_US = 460;
   ...
   */ tick(cpuCycles) {
        ...
        const trigHigh = trigState === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$avr8js$2f$dist$2f$esm$2f$peripherals$2f$gpio$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PinState"].High;
   ...
   */ generateEchoResponse(currentCycles) {
...
"[project]/utils/simulation/keypad.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class KeypadDevice {
   ...
   */ tick() {
        ...
        for(let col = 0; col < this.colPorts.length; col++){
            ...
            if (colPinState !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$avr8js$2f$dist$2f$esm$2f$peripherals$2f$gpio$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PinState"].Input && colPinState !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$avr8js$2f$dist$2f$esm$2f$peripherals$2f$gpio$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PinState"].InputPullUp) {
                continue;
            }
            ...
            for(let row = 0; row < this.rowPorts.length; row++){
                ...
                if (rowPinState === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$avr8js$2f$dist$2f$esm$2f$peripherals$2f$gpio$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PinState"].Low && this.getButtonState(row, col)) {
                    shouldPullLow = true;
                    break;
                }
            }
...
function getKeyLabel(row, col, keys = DEFAULT_KEYPAD_KEYS) {
    if (row >= 0 && row < keys.length && col >= 0 && col < keys[row].length) {
        return keys[row][col];
    }
    return null;
}
function findKeyPosition(label, keys = DEFAULT_KEYPAD_KEYS) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$simulation$2f$servo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/simulation/servo.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$simulation$2f$hcsr04$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/simulation/hcsr04.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$simulation$2f$keypad$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/simulation/keypad.ts [app-client] (ecmascript)");
...
function buildAdjacency(connections) {
    ...
    for (const conn of connections){
        ...
        if (!adjacency1.has(a)) adjacency1.set(a, new Set());
        if (!adjacency1.has(b)) adjacency1.set(b, new Set());
        adjacency1.get(a).add(b);
        adjacency1.get(b).add(a);
    }
    return adjacency1;
}
function findConnectedMcuDigitalPin(adjacency1, startKey, mcuId) {
    const queue = [
        startKey
    ];
    ...
    while(queue.length){
        ...
        const neighbors = adjacency1.get(cur);
...
function useSimulation(hexData, partType) {
    ...
    const buttonPinMapRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(new Map());
    // Mappings for analog part IDs to ADC channel
    const analogChannelMapRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(new Map());
    // Current analog values per channel (0-1023)
    const analogValuesRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(new Map());
            ...
            if (!runnerRef.current) {
                try {
                    ...
                    try {
                        ...
                        if (mcuPart) {
                            const adjacency1 = buildAdjacency(connections);
                            for (const part of circuitParts){
                                const typeLower = part.type.toLowerCase();
                                ...
                                for (const pinName of possiblePinNames){
                                    ...
                                    const pin = findConnectedMcuDigitalPin(adjacency1, startKey, mcuPart.id);
                                    if (pin != null) {
                                        foundPin = pin;
                                        usedPinName = pinName;
                                        break;
                        ...
                        for (const part of circuitParts){
                            ...
                            servoDevicesRef.current.push(new __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$simulation$2f$servo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ServoDevice"]({
                                port: portBit.port,
                                bit: portBit.bit,
                                cpuFrequencyHz: 16_000_000,
                                onAngleChange: {
                                    "useSimulation.useCallback[run]": (angle)=>{
                        ...
                        for (const part of circuitParts){
                            ...
                            hcsr04DevicesRef.current.push(new __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$simulation$2f$hcsr04$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HCSR04Device"]({
                        ...
                        for (const part of circuitParts){
                            ...
                            keypadDevicesRef.current.push(new __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$simulation$2f$keypad$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["KeypadDevice"]({
                                rowPorts: rowPins,
                                colPorts: colPins,
                                getButtonState: {
                                    "useSimulation.useCallback[run]": (row, col)=>{
                                        const state = __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useAppStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"].getState();
                                        const pNow = state.circuitParts.find({
                                            "useSimulation.useCallback[run].pNow": (p)=>p.id === partId
                                        }["useSimulation.useCallback[run].pNow"]);
                                        ...
                                        const pressedKeys = attrs.pressedKeys;
                                        if (pressedKeys) {
                                            // Default key layout
                                            const keyLayout = [
                                                [
                        ...
                        for (const part of circuitParts){
                            ...
                            if (typeLower.includes('potentiometer') || typeLower.includes('photoresistor') || typeLower.includes('ntc') || typeLower.includes('ldr')) {
                                ...
                                for (const pinName of signalPins){
                                    const startKey = `${part.id}:${pinName}`;
                                    const mcuPin = findConnectedMcuDigitalPin(adjacency1, startKey, mcuPart.id);
    ...
    const setButtonState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSimulation.useCallback[setButtonState]": (partId, pressed)=>{
    ...
    }["useSimulation.useCallback[setButtonState]"], []);
    // Set analog value for a component (e.g., potentiometer)
    const setAnalogValue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSimulation.useCallback[setAnalogValue]": (partId, value)=>{
            // Update the interactive component manager
            const manager = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$simulation$2f$interactiveComponents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getInteractiveComponentManager"])();
            manager.setValue(partId, value);
            console.log(`[Analog] ${partId} set to ${value}`);
        }
    }["useSimulation.useCallback[setAnalogValue]"], []);
    return {
        run,
        stop,
        pause,
...
_s(useSimulation, "Jh5rOEZPn3yVxEh6SncYrv54RsM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useAppStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useAppStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useAppStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"]
...
/* ============================================
   ...
   ============================================ */ function SimulationCanvasInner({ canvasRef, isRunning, componentPinStates, componentPwmStates }) {
    ...
    // Refs for simulation control functions (set later after useSimulation hook)
    const setButtonStateRef1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const setAnalogValueRef1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const handleValueChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SimulationCanvasInner.useCallback[handleValueChange]": (partId, value)=>{
            ...
            setAnalogValueRef1.current?.(partId, value);
        }
    ...
    const handleButtonPress = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SimulationCanvasInner.useCallback[handleButtonPress]": (partId)=>{
            ...
            setButtonStateRef1.current?.(partId, true);
        }
    }["SimulationCanvasInner.useCallback[handleButtonPress]"], []);
    const handleButtonRelease = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SimulationCanvasInner.useCallback[handleButtonRelease]": (partId)=>{
            ...
            // Call simulation button state handler
            setButtonStateRef1.current?.(partId, false);
        }
    }["SimulationCanvasInner.useCallback[handleButtonRelease]"], []);
...
_s(SimulationCanvasInner, "e7SinqigLB575qGWRmJYm94XdIw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useAppStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useAppStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useAppStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"],
...
function Home() {
    ...
    const { run: simRun, stop: simStop, isRunning: simIsRunning, pinStates, pwmStates, serialOutput, clearSerialOutput, setButtonState, setAnalogValue } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useSimulation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSimulation"])(hex, compiledBoard ?? '');
...
_s5(Home, "ie5+kV6PPVBEcOjYQIBLuvpU41Q=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useAppStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useAppStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useAppStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"],
...
//# sourceMappingURL=_bfe70224._.js.map